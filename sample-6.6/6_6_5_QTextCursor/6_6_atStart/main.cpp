...
int main(int argc, char *argv[])
{
   ...
   QPushButton *btn1 = new QPushButton("Проверить позицию курсора");
   ...
   QObject::connect(btn1, &QPushButton::clicked, [=]() {
      ...
      qDebug() << "atStart" << cur.atStart();
      qDebug() << "atEnd" << cur.atEnd();
      qDebug() << "atBlockStart" << cur.atBlockStart();
      qDebug() << "atBlockEnd" << cur.atBlockEnd();
      qDebug() << "----------------";
   });
